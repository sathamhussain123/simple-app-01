...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            <div className="lg:hidden fixed top-0 left-0 right-0 z-50 h-16 glass-panel border-b border-slate-800 px-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <div className="h-8 w-8 rounded-lg bg-gradient-to-tr from-indigo-500 to-sky-400 flex items-center justify-center">
                        <span className="text-white font-bold text-sm">A</span>
                    </div>
                    <h1 className="text-lg font-black text-slate-100 uppercase tracking-tighter">AeroSync</h1>
                </div>
                <button
            ...
            {/* Sidebar Container */}
            <div className={`
                fixed lg:relative z-45 h-screen w-72 glass-panel border-r border-slate-800 flex flex-col justify-between py-10 transition-transform duration-300 ease-in-out
                ...
                <div className="px-8 mb-12 hidden lg:block">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-2xl font-black bg-clip-text text-transparent bg-gradient-to-r from-slate-100 to-slate-400 tracking-tight">
                            SATHAM-AeroSync <span className="text-indigo-400 px-1 opacity-90 rounded">POS</span>
                        </h1>
                    </div>
                ...
                <div className="px-8 mt-auto pt-8 border-t border-slate-800/50">
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-sm font-bold text-slate-200 truncate max-w-[100px]">{session?.user?.name || 'User'}</p>
